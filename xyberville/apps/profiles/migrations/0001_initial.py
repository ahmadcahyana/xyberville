    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('penyandang_cacat', models.PositiveSmallIntegerField(blank=True, null=True, choices=[(1, b'Tidak'), (2, b'Cacat Fisik'), (3, b'Tunanetra'), (4, b'Tunarungu'), (5, b'Cacat Mental'), (6, b'Cacat Fisik dan Mental'), (7, b'Lainnya')])),
                ...
                ('photo', models.ImageField(null=True, upload_to=b'avatar', blank=True)),
